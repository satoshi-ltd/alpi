...
- Image `satoshiltd/alpi`; PID 1 is a minimal init that forwards signals and reaps orphans, the daemon is its only child. UI via `docker exec -it <name> alpi` (no web terminal).
