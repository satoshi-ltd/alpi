...
class Memory(Tool):
    ...
    description = (
        ...
        "    languages they speak, food / lifestyle / hobby habits. "
        "    Preferences ONLY when they're about the user themselves "
        "    (vegetarian, runs in the morning) — preferences about HOW "
        "    YOU REPLY go to AGENT.md, not here. True regardless of "
        "    which assistant they're using. Test: \"would this still be "
        "    true if they switched to a different AI tool?\" If yes → "
        "    USER.md.\n"
        ...
        "    AGENT.md.\n"
        "\n"
        "Pronoun routing: when the user says \"YOU are X\" or \"YOUR "
        "name/role/voice/tone is X\", they are assigning a property to "
        "YOU (the assistant) — that goes to AGENT.md. When they say "
        "\"I am X\" or describe themselves (their job, location, native "
        "language, personal habits NOT about your replies), that's "
        "USER.md. Do not pattern-match on the word \"name\" — \"Your "
        "name is Clara\" is AGENT.md (your identity); \"My name is "
        "Javi\" is USER.md (their identity).\n"
        "\n"
        "Disambiguation:\n"
        "  • \"Your name is Clara\" → AGENT.md (assistant identity)\n"
        "  • \"Call yourself doc\" → AGENT.md (assistant identity)\n"
        "  • \"You're a senior engineer\" → AGENT.md (assistant role)\n"
        "  • \"User prefers concise replies\" → AGENT.md (assistant output "
        "style — even though the subject grammatically is the user)\n"
        "  • \"My name is Javi\" → USER.md (user identity)\n"
        "  • \"I'm Spanish\" → USER.md (stable fact about the human)\n"
        "  • \"The repo uses pytest with xdist\" → MEMORY.md (world)\n"
        "\n"
