...
_TOPIC_SUMMARIES: dict[str, str] = {
    ...
    "alp": "ALP protocol — planes, pinned identity, signed envelopes, peer list and capabilities, transports, the five core methods, budget, error codes.",
    "workgroups": "Workgroups — hub/member lifecycle, task and done markers, quorum, pipelines and their phase gates, per-phase write scopes, recipes, run cost, concurrency.",
    "architecture": "Internals — code structure, turn loop, scheduler, MCP, logging, env vars.",
    "config": "Every YAML field, its default, what it controls (TUI theme, sandbox, budget, schedule).",
