...
// 1:1 port of desktop/src/primitives/AlpiSilhouette.jsx — same path list, same viewBox. Tinted via the `color` prop.
const PATHS = [
...
export function AlpiMark({ size = 72, color = palettes.light.ink }) {
  return (
    <Svg width={size} height={size} viewBox="71 70 712 1022">
      {PATHS.map((d, i) => (
