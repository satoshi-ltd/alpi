...
- [ ] Build and publish `satoshiltd/alpi-umbrel:0.4.3` for
...
- In `alpi/docker-compose.yml`, pin the image by digest:
  `satoshiltd/alpi-umbrel:0.4.3@sha256:<digest>`
...
For example, Alpi `0.4.3` ships as Umbrel image tag `0.4.3` and
