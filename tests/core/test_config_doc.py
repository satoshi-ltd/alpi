...
_DOC_TOP_LEVEL_PREFIXES = {
    ...
    "network", "budget", "relay", "public_bio", "paused", "tiers", "retention",
}
...
DOCUMENTED_BUT_PARSED_ELSEWHERE = {
    ...
    "tools.web_search.backends",  # alpi/tools/web_search.py::_backends
    "alp.max_active_workgroups",  # alpi/alp/pipeline_queue.py::limit_origin reads raw YAML so absence stays absence
...
_CONFIG_CONTAINER_FIELDS = {
    ...
    "tui", "email", "alp", "host", "network", "budget", "relay", "tiers", "retention",
}
