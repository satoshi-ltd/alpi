"""``ALPI_PLATFORM`` env var injects a per-surface hint into the system
prompt so the agent behaves differently on cron, Telegram, and email
from how it behaves in the TUI."""
