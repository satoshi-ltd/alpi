...
description: Record a decision with its context, options considered, rationale, and dissent — so it can be understood and challenged later without re-litigating it from scratch
category: knowledge
version: 0.1.0
origin: user
requires_env: []
